...
var _user$project$Game$textGreen = A3(_elm_lang$core$Color$rgb, 160, 200, 160);
...
var _user$project$Game$_p2 = {ctor: '_Tuple2', _0: 200, _1: 300};
var _user$project$Game$halfWidth = _user$project$Game$_p2._0;
var _user$project$Game$halfHeight = _user$project$Game$_p2._1;
...
var _user$project$Game$moveComputer = F4(
	function (delta, point, computer, ball) {
		...
		return _elm_lang$core$Native_Utils.update(
			movedComputer,
			{
				x: A3(_elm_lang$core$Basics$clamp, 22 - _user$project$Game$halfWidth, _user$project$Game$halfWidth - 22, ball.x),
...
var _user$project$Game$_p3 = {ctor: '_Tuple2', _0: 400, _1: 600};
var _user$project$Game$gameWidth = _user$project$Game$_p3._0;
var _user$project$Game$gameHeight = _user$project$Game$_p3._1;
...
var _user$project$Game$player = function (y) {
	return A7(_user$project$Game$Paddle, 0, y, 0, 0, 0, 0, 200);
};
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			default:
				...
				var newBall = _elm_lang$core$Native_Utils.eq(state, _user$project$Game$Pause) ? ball : A4(_user$project$Game$moveBall, _p9, ball, player, computer);
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						state: newState,
						ball: newBall,
						player: A3(_user$project$Game$movePaddle, _p9, playerPoint, player),
						computer: A4(_user$project$Game$moveComputer, _p9, computerPoint, computer, newBall)
					});
		}
	});
var _user$project$Game$view = function (model) {
	var _p10 = model.size;
	var width = _p10.width;
	var height = _p10.height;
	var _p11 = model;
	var state = _p11.state;
	var ball = _p11.ball;
	var player = _p11.player;
	var computer = _p11.computer;
	var scores = A2(
...
var _user$project$Game$handleInput = F2(
	function (down, keyCode) {
		var _p12 = {ctor: '_Tuple2', _0: down, _1: keyCode};
		_v3_5:
		do {
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Game$init,
		update: F2(
			function (msg, model) {
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Game$update, msg, model),
